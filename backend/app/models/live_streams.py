...
from sqlalchemy import CheckConstraint, Computed, ForeignKeyConstraint
...
class LiveBet(SQLModel, table=True):
    ...
    date_time: datetime | None = Field(default=None, nullable=True)
